...
mu0 <- round(sample(seq(10,30,l=10),
                    1),
             2)
...
\begin{question}
 O prefeito de Ilhéus solicitou um estudo sobre a situação de desemprego na cidade. Uma amostra de \Sexpr{n} habitantes desempregados de Ilhéus incluiu dados sobre o número de semanas em que estavam sem emprego. Realize um teste de hipóteses para determinar se a duração média do desemprego em Ilhéus é \Sexpr{hipo} que a duração média nacional de \Sexpr{mu0} semanas. Use um nível de significância de \Sexpr{alfa}. Qual a sua conclusão?
...
%% \exname{Teste de hipotese para media: var desconhecida} 
