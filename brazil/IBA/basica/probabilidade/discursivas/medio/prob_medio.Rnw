...
\begin{solution} 
O indivíduo tem duas possibilidades de entrar na casa. A primeira se ele pegar a porta destrancada ou a segunda se ele pegar a porta trancada mais acertar qual é a chave. 
