...
Faça uma tabela de distribuição de frequências utilizando o critério de sturges e os métodos ensinado em aula e também um boxplot e responda as perguntas a seguir: 
