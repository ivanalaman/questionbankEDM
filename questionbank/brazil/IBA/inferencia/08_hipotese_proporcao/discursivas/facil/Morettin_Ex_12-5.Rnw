...
\begin{question}
  Lança-se uma moeda \Sexpr{trials} vezes e observa-se que ocorreram \Sexpr{suces} caras. Baseado nesse resultado, podemos afirmar, ao nível de \Sexpr{alfa*100}\% significância, que a moeda \Sexpr{deci3} é honesta? Apresente \textbf{todos} os cálculos que subsidiam sua resposta.
...
%% \exname{Teste de hipotese para proporção}  
